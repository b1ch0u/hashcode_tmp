...
class MultLine:
    ...
    def parse(self, lines, obj):
        repetitions_nb = getattr(obj, self.mult_var)
        setattr(obj, self.name, [instr.parse(lines, obj) for instr in self.lines
...
pprint(parse_from_grammar('/home/seb/prog/hashcode/2019-qual/misc/a_example.txt', '/home/seb/prog/hashcode/2019-qual/misc/2019.grammar'))